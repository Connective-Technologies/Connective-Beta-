...
import 'bounty4_model.dart';
export 'bounty4_model.dart';

class Bounty4Widget extends StatefulWidget {
  const Bounty4Widget({Key? key}) : super(key: key);

  @override
  _Bounty4WidgetState createState() => _Bounty4WidgetState();
}

class _Bounty4WidgetState extends State<Bounty4Widget> {
  late Bounty4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Bounty4Model());
  }
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Image.asset(
                                      'assets/images/PHOTO-2023-04-23-12-07-59.jpg',
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'Deadline: April 23, 2023; 11:59 PM',
                                          style: FlutterFlowTheme.of(context)
                                              .titleMedium
                                              .override(
                                                fontFamily: 'Outfit',
